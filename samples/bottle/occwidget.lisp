...
(defun set-shape-attributes (handle-shape color)
  ...
  (let* ((handle-atrib (#_Attributes (#_get handle-shape)))
         (handle-line (#_FaceBoundaryAspect (#_handle_Prs3d_Drawer::get handle-atrib))))
    (#_SetColor (#_handle_Prs3d_LineAspect::get handle-line) (#!_new Quantity_Color +Quantity_NOC_BLACK+))
    (#_SetWidth (#_handle_Prs3d_LineAspect::get handle-line) 2.0d0)
    (#_SetFaceBoundaryDraw (#_handle_Prs3d_Drawer::get handle-atrib) t)
    (#_SetFaceBoundaryAspect (#_handle_Prs3d_Drawer::get handle-atrib) handle-line)
...
(defun add-bottle (instance)
  (when (not (found-bottle instance))
    ...
    (let ((handle-ais-bottle (#!_new handle_AIS_Shape (#_new AIS_Shape (make-bottle)))))
      (#_SetMaterial (#_handle_AIS_InteractiveContext::get (#_getContext (occ-view instance)))
		     (#_get_handle handle-ais-bottle)
		     (#!_new Graphic3d_MaterialAspect +Graphic3d_NameOfMaterial_Gold+) t)
      (#_Display (#_handle_AIS_InteractiveContext::get (#_getContext (occ-view instance)))
