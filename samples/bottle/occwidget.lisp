...
(defun set-shape-attributes (handle-shape color)
  ...
  (let* ((handle-atrib (#_Attributes (#_get handle-shape)))
         (handle-line (#_FaceBoundaryAspect (#_handle::get_Prs3d_Drawer handle-atrib))))
    (#_SetColor (#_handle::get_Prs3d_LineAspect handle-line) (#!_new Quantity_Color +Quantity_NOC_BLACK+))
    (#_SetWidth (#_handle::get_Prs3d_LineAspect handle-line) 2.0d0)
    (#_SetFaceBoundaryDraw (#_handle::get_Prs3d_Drawer handle-atrib) t)
    (#_SetFaceBoundaryAspect (#_handle::get_Prs3d_Drawer handle-atrib) handle-line)
...
(defun add-bottle (instance)
  (when (not (found-bottle instance))
    ...
    (let ((handle-ais-bottle (#!_new handle (#_new AIS_Shape (make-bottle)))))
      (#_SetMaterial (#_handle::get_AIS_InteractiveContext (#_getContext (occ-view instance)))
		     (#_get_handle handle-ais-bottle)
		     (#!_new Graphic3d_MaterialAspect +Graphic3d_NameOfMaterial_Gold+) t)
      (#_Display (#_handle::get_AIS_InteractiveContext (#_getContext (occ-view instance)))
