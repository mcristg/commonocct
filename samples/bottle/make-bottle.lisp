...
(defun add-thread-neck (my-height my-neck-height my-neck-radius)
  (let ((neck-axis (#_gp::DZ))
    ...
    (with-objects (;; Threading : Create Surfaces
		   ...
		   (neck-ax3 (#_new gp_Ax3 neck-ax2))
		   (a-cyl1 (#_new handle_Geom_CylindricalSurface
				  (#_new Geom_CylindricalSurface neck-ax3 (* my-neck-radius 0.99d0))))
		   (a-cyl2 (#_new handle_Geom_CylindricalSurface
	...
	(with-objects ((h-an-ellipse1 (#_new handle_Geom2d_Ellipse an-ellipse1))
		       (h-an-ellipse2 (#_new handle_Geom2d_Ellipse an-ellipse2))
		       (an-arc1 (#_new handle_Geom2d_TrimmedCurve
				       (#_new Geom2d_TrimmedCurve (#_get_handle h-an-ellipse1) 0.0d0 pi)))
		       (an-arc2 (#_new handle_Geom2d_TrimmedCurve
